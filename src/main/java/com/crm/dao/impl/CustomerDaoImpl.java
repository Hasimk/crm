...
public class CustomerDaoImpl implements CustomerDao {
	...
	public boolean addCustomer(CustomerBean customerBean) {
		...
		if(count==1) {
			...
			jdbcTemplate.update("insert into customers(firstName,lastName,email,password,gender,country) values(?,?,?,?,?,?)", customerBean.getEmail(),customerBean.getFirstName(),customerBean.getLastName(),customerBean.getPassword(),gender,customerBean.getCountry());
			return true;
		}
	}
